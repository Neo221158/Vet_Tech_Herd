        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">VTH</span>
              </div>
              <span className="text-xl font-semibold">The Vet Tech Herd</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              A professional community connecting veterinarians working in the technology industry. 
              Join us to collaborate, share knowledge, and advance veterinary tech innovation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/collaboration" className="text-gray-300 hover:text-white transition-colors">Collaboration</Link></li>
